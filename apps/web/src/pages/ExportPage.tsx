      ...
      <WorkspaceAside testid="export-aside">
        ...
        {format === 'xlsx' ? (
          <Banner tone="info" testid="export-xlsx-note">
            Excel — только выгрузка таблицы: вложенность показана отступами имени, связи — словами;
            RICE-оценки, сроки источников и признак AI-происхождения в лист не попадают, а повторный
            импорт из .xlsx не поддерживается. Для полного переноса проекта берите архив.
          </Banner>
        ) : null}
