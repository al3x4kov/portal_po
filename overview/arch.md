...
- **React + Vite + TypeScript + Tailwind** (макеты в `uiux/` — тот же визуальный язык,
...
| Фронт | React + Vite + Tailwind | скорость, совместимость с макетами uiux/ |
...
зафиксировать на старте разработки (см. задачи фундамента в `tasks/`).
